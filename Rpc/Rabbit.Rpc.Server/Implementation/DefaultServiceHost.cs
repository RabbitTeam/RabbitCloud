...
namespace Rabbit.Rpc.Server.Implementation
{
    ...
    public class DefaultServiceHost : IServiceHost
    {
        ...
        public DefaultServiceHost(ISerializer<byte[]> serializer, IServiceEntryLocate serviceEntryLocate, ILogger<DefaultServiceHost> logger)
        {
        ...
        private class ServerHandler : ChannelHandlerAdapter
        {
            ...
            public ServerHandler(ISerializer<byte[]> serializer, IServiceEntryLocate serviceEntryLocate, ILogger logger)
            {
                _serializer = serializer;
                _serviceEntryLocate = serviceEntryLocate;
                _logger = logger;
