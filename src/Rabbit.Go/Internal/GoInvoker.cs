...
{
    public abstract class GoInvoker : IGoRequestInvoker
    {
        ...
        protected GoInvoker(RequestContext requestContext, IFilterMetadata[] filters)
        {
        ...
        private async Task InvokeNextExceptionFilterAsync()
        {
            ...
            {
                ExceptionContext = new ExceptionContext(RequestContext, Filters)
                {
                ...
                case State.ResultNext:
                    {
                        ...
                        if (current.FilterAsync != null)
                        {
                            ...
                            {
                                ResultExecutingContext = new ResultExecutingContext(RequestContext, Filters, Result);
                            }
                ...
                case State.ResultEnd:
                    {
                        ...
                        if (scope == Scope.Result)
                        {
                            ...
                            {
                                ResultExecutedContext = new ResultExecutedContext(RequestContext, Filters, result);
                            }
        ...
        private Task InvokeResultAsync(object result)
        {
            return Task.CompletedTask;
        }
        ...
        public virtual async Task InvokeAsync()
        {
            ...
            RequestContext.RabbitContext.Response.Body = Result;
        }
    }
}