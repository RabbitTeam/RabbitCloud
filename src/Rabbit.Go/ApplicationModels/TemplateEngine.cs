...
namespace Rabbit.Go.ApplicationModels
{
    ...
    {
        public TemplateRenderContext(string template, IDictionary<string, string> variables)
        {
            Template = template;
            Variables = variables;
        }
    ...
    {
        public static TemplateRenderContext Render(this ITemplateEngine templateEngine, string template, IDictionary<string, string> variables)
        {
