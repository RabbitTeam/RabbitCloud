...
namespace Rabbit.Go.ApplicationModels.Internal
{
    public class DefaultApplicationModelProvider : IApplicationModelProvider
    {
        ...
        {
            var targetProvider = parameterModel.Attributes.OfType<IParameterProvider>().FirstOrDefault();
        ...
        {
            var targetProvider = attributes.OfType<IParameterProvider>().FirstOrDefault();
        ...
        {
            var requestProvider = method.GetTypeAttribute<IRequestProvider>();
            if (requestProvider != null && !string.IsNullOrEmpty(requestProvider.Path))
                return requestProvider.Path;
